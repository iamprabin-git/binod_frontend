    ...
    <section className="bg-white dark:bg-gray-900 border-2 rounded-2xl border-gray-200 dark:border-gray-700">
      <form onSubmit={handleSubmit}>
        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6 m-10">
          ...
          <button
            type="submit"
            className="w-full items-center px-2 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center bg-green-800 text-white hover:opacity-65 rounded-lg transition-colors duration-200"
          >
            Create Tour Package
          </button>
        </div>
